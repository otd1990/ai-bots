<template>
    <aside>
        ...
        <p>Give me a keyword or a feeling or a theme and I'll do my best to match it to the dataset* I am programmed with</p>
    ...
    <section class="movie-recommendation-container">
      ...
      <section class="user-input">
        <input v-model="data.userInput" @keyup.enter="sendMessage" placeholder="Type your keywords...">
